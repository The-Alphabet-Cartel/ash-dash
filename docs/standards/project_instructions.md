...
- Read and follow the Clean Architecture Charter (`\10.20.30.253\ash-dash\docs\standards\clean_architecture_charter.md`) to the letter.
...
- Modular Python Code
  ...
  - Python is only accessible from within the Docker container
    - `docker exec ash-dash python *script_to_run.py*`
- **No Bash Scripting!**
